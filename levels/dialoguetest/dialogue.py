...
default = Dialogue([
    ...
    DialogueBox("sprites/players/axodialogue1.png", "HEY! He's not a baby any more."), #Mission Control

    DialogueBox("sprites/players/axodialogue1.png", "And he can be a real pain sometimes..."),
    DialogueBox("sprites/players/axodialogue1.png", "Just like his father!!"), #Dude 1
    DialogueBox("sprites/players/axodialogue1.png", "Didn't know you had a kid."), # Dude 1
    DialogueBox("sprites/players/axodialogue1.png", "What?"), #Mission Control
    DialogueBox("sprites/players/axodialogue1.png", "What?"), #Dude 1
    DialogueBox("sprites/players/axodialogue1.png", "For the record, the kid's my brother's son."), #Mission Control
    DialogueBox("sprites/players/axodialogue1.png", "Does your brother know he's here?"), #Dude 1
    DialogueBox("sprites/players/axodialogue1.png", "Enough questions, just complete this so we can move on to the important mission!"), #Mission Control
])
