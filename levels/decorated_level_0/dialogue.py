...
default = Dialogue([
    ...
    DialogueBox("sprites/players/missioncontrol1.png", "Your goal is to get the candy currently in the hands of a five-year-old child."),  #Mission Control
    ...
    DialogueBox("sprites/players/missioncontrol1.png", "And he can be a real pain sometimes..."),#Mission Control
    DialogueBox("sprites/players/missioncontrol1.png", "Just like his father..."), #Mission Control
...
lookingfor = Dialogue([
    ...
    DialogueBox("sprites/players/missioncontrol1.png", "What are you guys looking for?"), #Mission Control
    DialogueBox("sprites/players/axolotldialogue.png", "Our stuff."), #Dude 1
    DialogueBox("sprites/players/missioncontrol1.png", "Stuff? What stuff?"), #Mission Control
    DialogueBox("sprites/players/axolotldialogue.png", "You know, our equipment."), #Dude 1
    DialogueBox("sprites/players/missioncontrol1.png", "You have everything you need."), #Mission Control
